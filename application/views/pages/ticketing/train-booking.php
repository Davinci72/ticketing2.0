                ...
                <table class="table table-bordered u-table--v2">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <form action="<?=base_url('send_push')?>" method="post">
                                <!-- Quantity -->
                                <div class="form-group">
                                    ...
                                    <div class="js-minus input-group-prepend  g-color-gray g-bg-grey-light-v3">
                                        <span class="input-group-text rounded-1" onclick="minusMe('tickets')"><i class="fa fa-minus"></i></span>
                                    </div>
                                    <input id="tickets" class="js-result form-control text-center rounded-0" type="text" value="1" readonly="">
                                    <div class="js-plus input-group-append  g-color-gray g-bg-grey-light-v3">
                                        <span class="input-group-text rounded-1" onclick="AddMe('tickets')"><i class="fa fa-plus"></i></span>
                                    </div>
                            <!-- End Quantity -->
                            </div>
                      </td>
                      <td class="align-middle">
                                ...
                                <div class="form-group">
                                    <div class="js-quantity input-group u-quantity-v1  g-brd-primary--focus">
                                    <div class="js-minus input-group-prepend  g-color-gray g-bg-grey-light-v3">
                                        <span class="input-group-text rounded-1" onclick="minusMe('tickets_kids')"><i class="fa fa-minus"></i></span>
                                    </div>
                                    <input id="tickets_kids" class="js-result form-control text-center rounded-0" type="text" value="1" readonly="">
                                    <div class="js-plus input-group-append  g-color-gray g-bg-grey-light-v3">
                                        <span class="input-group-text rounded-1" onclick="AddMe('tickets_kids')"><i class="fa fa-plus"></i></span>
                                    </div>
                            <!-- End Quantity -->
                            </div>
                      </td>
                    ...
                    <td class="align-middle text-nowrap" colspan="4">
                      ...
                      <td class="align-middle text-nowrap" colspan="2">
                        <h4 class="h6 g-mb-2">KSHS : <span id="tot">100</span> /=</h4>
                        <input type="text" id="total_amount" name="total_amt" value="100" hidden>
                      </td>
                    </tr>
                    <tr>
                    <td class="align-middle text-nowrap" colspan="4">
                        <h4 class="h6 g-mb-2">Booking Date / Time  : </h4>
                      </td>
                      <td class="align-middle text-nowrap" colspan="2">
                        <h4 class="h6 g-mb-2"><?=$ts?></h4>
                      </td>
                    </tr>
                  </tbody>
                </table>
     ...
     <div class="container g-py-0">
        ...
        <hr class="u-divider-linear-gradient u-divider-linear-gradient--gray-light-v2 g-my-0">
            ...
            <hr class="u-divider-linear-gradient u-divider-linear-gradient--gray-light-v2 g-my-0">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <label for="disabledSelect">M-PESA Mobile No *</label>
                            <input id="inputGroup9_1" class="form-control rounded-0" name="mpesa_no" type="text" placeholder="M-PESA Mobile No *">
                            <small class="form-control-feedback">This is a required field.</small>
                        </div>
                    </div>
                    <div class="col-md-5">
                ...
                <button type="submit" class="btn btn-sm btn-block u-btn-primary g-mb-10">Book Your Ticket</button>
                </div>
                </form>
...
function AddMe(id){
  var tickets = document.getElementById(id).value;
  var n = Number(tickets);
  var fn = n + 1;
  var totalAmt = fn * 100;
  document.getElementById("tot").innerHTML = totalAmt;
