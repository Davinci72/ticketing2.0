...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6/multipage/real-estate/home-page-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Sep 2018 09:21:08 GMT -->
<head>
    <!-- Title -->
    ...
    <!-- CSS Unify Theme -->
    <link rel="stylesheet" href="<?=base_url('assets3/css/styles.multipage-real-estate.css')?>">
                ...
                <li class="nav-item hs-has-sub-menu">
                  ...
                  <ul id="nav-submenu--listing" class="hs-sub-menu list-unstyled u-shadow-v11 g-min-width-220 g-mt-2"
                    ...
                    <li class="dropdown-item">
                      <a class="nav-link g-color-text g-font-weight-600" href="<?=base_url('nairobi-commuter-rail')?>">Nairobi Commuter Rail</a>
                    </li>
                    <li class="dropdown-item">
                      <a class="nav-link g-color-text g-font-weight-600" href="<?=base_url('bus-rapid-transport')?>">BRT</a>
                    </li>
                  </ul>
                  <!-- End Submenu -->
                </li>
