<div class="footer">
            ...
            <div>
                <strong>Copyright</strong> Cosmere Ventures &copy; 2019-2020
            </div>
        </div>
        </div>
    </div>
    ...
    <!-- Jvectormap -->
    <script src="<?=base_url('assets/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js')?>"></script>
   ...
   <!-- Input Mask-->
    ...
    <!-- DROPZONE -->
    <script src="<?=base_url('assets/js/plugins/dropzone/dropzone.js')?>"></script>

    <!-- CodeMirror -->
    <script src="<?=base_url('assets/js/plugins/codemirror/codemirror.js')?>"></script>
    <script src="<?=base_url('assets/js/plugins/codemirror/mode/xml/xml.js')?>"></script>
    ...
    <script>
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                pageLength: 10,
                responsive: true,
                ajax: 'http://localhost/water/get-users',
                buttons: [
                    { extend: 'copy'},
                    {extend: 'csv'},
