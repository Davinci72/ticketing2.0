    ...
    <script src="<?=base_url('assets/vendor/jquery-ui/ui/widgets/slider.js')?>"></script>
    ...
    <script src="<?=base_url('assets/js/components/hs.slider.js')?>"></script>
...
<!-- Mirrored from htmlstream.com/preview/unify-v2.6/multipage/real-estate/home-page-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Sep 2018 09:21:34 GMT -->
</html>
